...
export const SubscriptionsPage = () => {
  ...
  const subscriptions = data?.channels || []
  ...
  if (!subscriptions.length) return (
    <EmptyState
      ...
      description="Subscribe to channels you like!"
    />
  )
      ...
      <div className="space-y-3">
        {subscriptions.map((sub) => {
          ...
          return (
            <div
              key={sub._id}
              className="flex items-center gap-4 p-4 border border-gray-200 dark:border-gray-800 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors"
            >
              {/* ✅ /channel → /c */}
